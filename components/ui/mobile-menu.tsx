      ...
      <div ref={mobileNav}>
        ...
        >
          <ul className="px-5 py-2">
            <li>
              <Link href="/" className="font-medium w-full text-gray-600 hover:text-gray-900 py-2" onClick={() => setMobileNavOpen(false)}>For Community</Link>
            </li>
            <li>
              <Link href="/about" className="font-medium w-full text-gray-600 hover:text-gray-900 py-2" onClick={() => setMobileNavOpen(false)}>For Projects</Link>
            </li>
            <li>
