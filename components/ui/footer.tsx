    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            ...
            <div className="text-sm text-gray-600">
              <p className="text-gray-600 hover:text-gray-900 hover:underline transition duration-150 ease-in-out">
                Explore the potential, discover the
                possibilities, and be part of a brighter
                future for Africa.
              </p>
            </div>
          </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; blockchaininafrica.com. All rights reserved.</div>
